              ...
              <div className="inner-content">
                  ...
                  <div className="row">
                    <div className="col-lg-5 col-md-5 col-12">
                      <div className="name-head">
                        <a className="mb-2" href="resume.html#">
                          <img
                            className="circle-54"
                        ...
                        <h4>
                          <a className="name" href="resume.html#">
                            David Henricks
                          </a>
                        </h4>
                        <p>
                          <a className="deg" href="resume.html#">
                            Product Designer
                          </a>
                        </p>
                        <ul className="social">
                    ...
                    <div className="col-lg-7 col-md-7 col-12">
                      <div className="content-right">
                        ...
                        <div className="single-list">
                          ...
                          <p>
                            <a href="resume.html#">yourwebsite.com</a>
                          </p>
                        </div>
                        {/* <!-- Single List --> */}
                      </div>
                ...
                <div className="single-section skill">
                  ...
                  <ul className="list-unstyled d-flex align-items-center flex-wrap">
                    ...
                    <li>
                      <a href="resume.html#">Wireframing</a>
                    </li>
                    <li>
                      <a href="resume.html#">Prototyping</a>
                    </li>
                    <li>
                      <a href="resume.html#">Information</a>
                    </li>
                    <li>
                      <a href="resume.html#">Waterfall Model</a>
                    </li>
                    <li>
                      <a href="resume.html#">New Layout</a>
                    </li>
                    <li>
                      <a href="resume.html#">Ui/Ux Design</a>
                    </li>
                    <li>
                      <a href="resume.html#">Web Design</a>
                    </li>
                    <li>
                      <a href="resume.html#">Graphics Design</a>
                    </li>
                  </ul>
                </div>
                {/* <!-- End Single Section --> */}
                ...
                <div className="single-section exprerience">
                  ...
                  <div className="single-exp mb-30">
                    <div className="d-flex align-items-center pr-11 mb-9 flex-wrap flex-sm-nowrap">
                      ...
                      <div className="w-100 mt-n2">
                        <h3 className="mb-0">
                          <a href="resume.html#">Lead Product Designer</a>
                        </h3>
                        <a href="resume.html#">Airabnb</a>
                        <div className="d-flex align-items-center justify-content-md-between flex-wrap">
                          <a href="resume.html#">
                            Jun 2020 - April 2023- 3 years
                          </a>
                          <a
                            href="resume.html#"
                  ...
                  <div className="single-exp mb-30">
                    <div className="d-flex align-items-center pr-11 mb-9 flex-wrap flex-sm-nowrap">
                      ...
                      <div className="w-100 mt-n2">
                        <h3 className="mb-0">
                          <a href="resume.html#">Senior UI/UX Designer</a>
                        </h3>
                        <a href="resume.html#">Google Inc</a>
                        <div className="d-flex align-items-center justify-content-md-between flex-wrap">
                          <a href="resume.html#">
                            Jun 2020 - April 2023- 3 years
                          </a>
                ...
                <div className="single-section education">
                  ...
                  <div className="single-edu mb-30">
                    <div className="d-flex align-items-center pr-11 mb-9 flex-wrap flex-sm-nowrap">
                      ...
                      <div className="w-100 mt-n2">
                        <h3 className="mb-0">
                          <a href="resume.html#">Masters in Art Design</a>
                        </h3>
                        <a href="resume.html#">Harvard University</a>
                        <div className="d-flex align-items-center justify-content-md-between flex-wrap">
                          <a href="resume.html#">
                            Jun 2020 - April 2023- 3 years
                          </a>
