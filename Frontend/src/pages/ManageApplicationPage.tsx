            ...
            <div className="col-lg-4 col-12">
              <div className="dashbord-sidebar">
                <ul>
                  ...
                  <li>
                    <a href="resume.html">
                      <i className="lni lni-clipboard"></i> My Resume
                    </a>
                  </li>
                  <li>
                    <a href="bookmarked.html">
                      <i className="lni lni-bookmark"></i> Bookmarked Jobs
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a className="active" href="manage-applications.html">
                  ...
                  <li>
                    <a href="manage-jobs.html">
                      <i className="lni lni-briefcase"></i> Manage Jobs
                    </a>
                  </li>
                  <li>
            ...
            <div className="col-lg-8 col-12">
                  ...
                  <div className="row align-items-center justify-content-center">
                    <div className="col-lg-5 col-md-5">
                      <div className="title-img">
                        ...
                        <h3>
                          Content Writing <span>Depan insider ltd.</span>
                        </h3>
                      </div>
                    </div>
                    <div className="col-lg-2 col-md-2">
                  ...
                  <div className="row align-items-center justify-content-center">
                    <div className="col-lg-5 col-md-5">
                      <div className="title-img">
                        ...
                        <h3>
                          Teacher - English <span>Eduon education</span>
                        </h3>
                      </div>
                    </div>
                    <div className="col-lg-2 col-md-2">
                  ...
                  <div className="row align-items-center justify-content-center">
                    <div className="col-lg-5 col-md-5">
                      <div className="title-img">
                        ...
                        <h3>
                          Service Engineer <span>Autozon power ltd</span>
                        </h3>
                      </div>
                    </div>
                    <div className="col-lg-2 col-md-2">
                  ...
                  <div className="row align-items-center justify-content-center">
                    <div className="col-lg-5 col-md-5">
                      <div className="title-img">
                        ...
                        <h3>
                          Support Executive <span>Saspol limited</span>
                        </h3>
                      </div>
                    </div>
                    <div className="col-lg-2 col-md-2">
                  ...
                  <div className="row align-items-center justify-content-center">
                    <div className="col-lg-5 col-md-5">
                      <div className="title-img">
                        ...
                        <h3>
                          Research Assistant <span>Medq medical</span>
                        </h3>
                      </div>
                    </div>
                    <div className="col-lg-2 col-md-2">
              ...
              <div className="pagination left pagination-md-center">
                <ul className="pagination-list">
                  ...
                  <li className="active">
                    <a href="manage-applications.html#">1</a>
                  </li>
                  <li>
                    <a href="manage-applications.html#">2</a>
                  </li>
                  <li>
                    <a href="manage-applications.html#">3</a>
                  </li>
                  <li>
                    <a href="manage-applications.html#">4</a>
                  </li>
                  <li>
                    <a href="manage-applications.html#">
