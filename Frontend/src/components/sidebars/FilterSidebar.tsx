      ...
      <Card.Body className="p-3">
        ...
        <Card className="border-0 mb-2">
          <Card.Header
            ...
            style={{
              background: 'linear-gradient(90deg, #A3BFFA, #E2E8F0)',
        ...
        <Card className="border-0 mb-2">
          ...
          >
            ...
            <span className="fw-semibold text-dark">Hourly Rate</span>
          </Card.Header>
          <Card.Body className="p-2 bg-light rounded-bottom">
            <div className="mb-2">
              <div className="d-flex justify-content-between mb-1">
                <span className="badge bg-primary p-1">${hourlyRate[0]}</span>
                <span className="badge bg-primary p-1">${hourlyRate[1]}</span>
              </div>
              <Form.Range
                min={5}
                max={200}
                value={hourlyRate[1]}
                onChange={(e) =>
                  setHourlyRate([hourlyRate[0], parseInt(e.target.value)])
                }
                className="mb-1"
              />
        ...
        <Card className="border-0 mb-2">
          ...
          >
            ...
            <span className="fw-semibold text-dark">Certifications</span>
          </Card.Header>
          <Card.Body className="p-2 bg-light rounded-bottom">
            <InputGroup className="mb-2 shadow-sm">
              <InputGroup.Text className="bg-white border-end-0">
